...
<ul class="navbar-nav topbar topbar-dark mb-3" id="accordionTopBar">
    <li class="nav-item d-flex ml-auto mt-3 mr-2 p-2" tooltipl>
        ...
        <a style="border-radius: 45%; color: white;" class="btn btn-sm btn-danger" href="#" data-toggle="modal" title="Logout button" data-target="#logoutModal">
